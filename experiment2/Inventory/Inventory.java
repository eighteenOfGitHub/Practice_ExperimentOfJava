...
class getInventory {
    ...
    BufferedWriter errorWriter = new BufferedWriter(new FileWriter("C:\\Users\\陈祥烨\\Desktop\\java实验\\experiment2\\Inventory\\Error.txt",true));
    Goods good = null;
    public getInventory() throws Exception {
        //加载数据
        BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\陈祥烨\\Desktop\\java实验\\experiment2\\Inventory\\Inventory.txt"));
        String line = null;
    ...
    class getTransactions { // 此类用于从transactions.txt中读取数据并且处理
        ...
        public getTransactions() throws Exception {
            BufferedReader readTrans = new BufferedReader(
                    new FileReader("C:\\Users\\陈祥烨\\Desktop\\java实验\\experiment2\\Inventory\\transactions.txt"));
        ...
        void WriteFile() throws IOException {
            BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\陈祥烨\\Desktop\\java实验\\experiment2\\Inventory\\NewInventory.txt"));
        ...
        void checkShipping() throws Exception {
            BufferedWriter shippingWriter = new BufferedWriter(
                    new FileWriter("C:\\Users\\陈祥烨\\Desktop\\java实验\\experiment2\\Inventory\\shipping.txt")) ;
            //删除 0 数量
            for(int i  = 0;i < shippingBuffer.size() - 1; i++){
                if(Integer.parseInt(shippingBuffer.get(i).toString().split("\t")[1])== 0){
